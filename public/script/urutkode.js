const leftBox = document.getElementById("leftBox");
        ...
        function buatDraggable() {
            ...
            rightBox.innerHTML = '<p class="text-center fw-bold">Susun Kode di Sini</p>';
        ...
        document.querySelectorAll(".dropzone").forEach(zone => {
            ...
            zone.addEventListener("drop", (e) => {
                ...
                const item = document.querySelector(`.drag-item[data-order='${order}']`);
        ...
        checkBtn.addEventListener("click", () => {
            ...
            let benar = JSON.stringify(urutanUser) === JSON.stringify(kodeUrutan.map(k => k.order.toString()));
