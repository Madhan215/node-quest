...
@section('container-kuis')
    ...
    <script>
        ...
        const questions = [{
                ...
                "options": ["Mengelola sesi pengguna", "Menangani permintaan dan respons HTTP",
                    "Menghubungkan aplikasi dengan database", "Memproses data gambar"
                ],
                "answer": 1,
                "userAnswer": null
            },
            {
                ...
                "options": ["Agar proses dapat berjalan secara bersamaan tanpa harus menunggu request lain selesai",
                    "Untuk meningkatkan keamanan komunikasi antara server dan klien",
                    "Untuk membatasi jumlah koneksi yang diterima oleh server",
                    "Supaya setiap request diproses secara berurutan tanpa tumpang tindih"
                ],
                "answer": 0,
                "userAnswer": null
            },
            {
                ...
                "options": ["Server mengirimkan permintaan ke klien", "Klien mengirimkan permintaan ke server",
                    "Klien dan server saling mengirim permintaan secara bersamaan",
                    "Server mengambil data dari klien tanpa permintaan"
                ],
                "answer": 1,
                "userAnswer": null
            },
            {
                ...
                "options": ["Mengatur komunikasi antara klien dan server di web",
                    "Mengelola pengolahan data dalam sistem operasi",
                    "Meningkatkan keamanan transfer data dalam jaringan lokal",
                    "Menghubungkan perangkat keras dengan aplikasi server"
                ],
                "answer": 0,
                "userAnswer": null
            },
            {
                ...
                "options": ["Menghubungkan Node.js dengan database",
                    "Membuat server yang dapat menangani permintaan HTTP", "Menghapus file dari sistem file",
                    "Memproses data JSON dalam aplikasi web"
                ],
                "answer": 1,
                "userAnswer": null
            },
            {
                ...
                "options": ["Menggunakan fungsi fs.readFile() untuk mengambil data dari file",
                    "Memanfaatkan querystring atau URL module untuk memproses req.url",
                    "Menggunakan metode http.getParameter() untuk membaca parameter query",
                    "Menjalankan fungsi http.createServer() dengan tambahan opsi khusus"
                ],
                "answer": 1,
                "userAnswer": null
            },
            {
                ...
                "options": ["Klien mungkin tidak memahami apakah permintaannya berhasil atau gagal",
                    "Server akan secara otomatis menampilkan halaman error 404",
                    "Data yang dikirim oleh server akan selalu diterima oleh klien tanpa error",
                    "Koneksi antara server dan klien akan langsung terputus"
                ],
                "answer": 0,
                "userAnswer": null
            },
            {
                ...
                "options": ["Hypertext Transfer Protocol", "Hyperlink Transmission Process", "Hyper Data Transfer Page",
            ...
            },
            {
                ...
                "options": ["Permintaan berhasil dan server mengirimkan respons yang diharapkan",
                    "Permintaan tidak valid atau salah format", "Server sedang mengalami kesalahan internal",
                    "Sumber daya tidak ditemukan di server"
                ],
                "answer": 0,
                "userAnswer": null
            },
            {
                ...
                "options": ["Agar server dapat berjalan lebih cepat",
                    "Untuk memberi tahu klien apakah permintaan berhasil atau gagal",
                    "Supaya server dapat menyimpan data permintaan dalam database",
                    "Untuk menghindari serangan keamanan dari klien"
                ],
                "answer": 1,
                "userAnswer": null
            }
