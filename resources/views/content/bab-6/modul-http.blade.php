...
@section('container-base-content')
    ...
    <p class="lh-lg">
        Modul HTTP (Hypertext Transfer Protocol) merupakan modul bawaan yang ada pada Node.js yang memungkinkan pengembangan
        untuk membuat web server dan mengelola permintaan respons HTTP. Modul HTTP merupakan fondasi yang digunakan dalam
        komunikasi antara klien dan server seperti mengirimkan dan menerima data.
    </p>
    <figure class="text-center">
        <a href="{{ asset('img/bab6-1/no-49.png') }}" data-fancybox="gallery"
            data-caption="Gambar 35. Ilustrasi komunikasi Klien dan Server dengan HTTP">
            <img class="img-fluid d-block mx-auto my-2 shadow" src="{{ asset('img/bab6-1/no-49.png') }}"
                alt="Gambar 35. Ilustrasi komunikasi Klien dan Server dengan HTTP" style="max-height: 400px;">
        </a>
        <figcaption class="figure-caption text-center">Gambar 35. Ilustrasi komunikasi Klien dan Server dengan HTTP
        </figcaption>
    </figure>
    <p class="lh-lg">
