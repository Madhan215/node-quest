...
@section('container-base-content')
    ...
    <p class="lh-lg">
        Modul pada Node.js mirip dengan Library pada JavaScript, yaitu kumpulan fungsi yang dapat digunakan dalam aplikasi.
        Modul ini dapat mencakup fungsi, objek, dan variabel. Sehingga dengan adanya Modul, pengguna tidak perlu membuat
        fungsi tersebut dari awal. Sebelum menggunakan modul, terlebih dahulu perlu di-import kedalam file program yang
        dibuat. Modul Node.js berisi fungsionalitas komplek yang tersimpan dalam file JavaScript. Setiap modul Node.js
        memiliki konteksnya masing-masing, tidak dapat saling tercampur dengan modul lainnya dalam lingkup Global.
    </p>
    ...
    <ol class="list-group list-group-numbered">
        <li class="text-dark m-0 p-0 border-0 ms-3 mt-2 list-group-item d-flex justify-content-between align-items-start">
            <div class="ms-2 me-auto">
                ...
                <p>Modul bawaan yang ada pada sistem Node.js, cara menggunakannya langsung dengan menggunakan fungsi
                    require(). Contoh modul ini: fs, http, os, dan lain-lain.</p>
            </div>
        </li>
        <li class="text-dark m-0 p-0 border-0 ms-3 mt-2 list-group-item d-flex justify-content-between align-items-start">
            <div class="ms-2 me-auto">
                <p class="text-primary m-0">Local Moduls</p>
                <p>Modul yang dibuat oleh pengembang, biasanya memakai perintah exports untuk meng-ekspor program yang telah
                    dibuat agar dapat digunakan pada program atau script lain.</p>
            </div>
        </li>
        <li class="text-dark m-0 p-0 border-0 ms-3 mt-2 list-group-item d-flex justify-content-between align-items-start">
            <div class="ms-2 me-auto">
                <p class="text-primary m-0">Third Party Moduls</p>
                <p>Modul ini dibuat oleh pihak ke tiga, yang dapat dipakai pada script Node.js. Sebagai contoh: moments,
                    dev, global, dan lainnya. Modul ini disebut juga dengan NPM (Node Package Manager) yang akan dipelajari
                    secara mendalam di BAB 3.</p>
            </div>
        </li>
    </ol>
