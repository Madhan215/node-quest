...
@section('container-kuis')
        ...
        <div class="container">
            <div class="g-0 my-auto row justify-content-center">
                ...
                <div class="d-flex justify-content-center p-3">
                    ...
                    <a href="/npm/npm" class="btn btn-primary" id="btn_materi_berikutnya" style="display: none">Materi Berikutnya</a>
                </div>
            </div>
        </div>
    </div>
    ...
    },
    {
        ...
        "options": ["Membuat variabel baru", "Menulis ulang seluruh kode", "Mengimpor modul menggunakan require()", "Menginstal ulang Node.js"],
        "answer": 2,
        "userAnswer": null
    },
    {
    ...
    },
    {
        ...
        "options": ["Nama modul dan ekstensi", "Path atau lokasi file modul", "Kata kunci import", "Nama folder node_modules"],
        "answer": 1,
        "userAnswer": null
    },
    {
