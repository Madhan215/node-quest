...
@section('container-base-content')
    ...
    <p class="lh-lg">
        Dalam menggunakan modul bawaan dari Node.js cukup dengan memakai fungsi require(). Node.js memiliki banyak core
        modul yang bisa dimanfaatkan dalam pembuatan aplikasi. Core Moduls tidak perlu diinstal dengan NPM, karena sudah
        tersedia sejak awal penginstallan Node.js. Berikut beberapa contoh core moduls:
    </p>
    <ul class="list-group list-group-flush">
        <li class="text-dark m-0 p-0 border-0 ms-3 mt-2 list-group-item">
            <div class="d-flex align-items-start">
                ...
                <div>
                    <p class="mb-1">http</p>
                    http merupakan modul yang digunakan untuk melakukan perintah http (HTTP Request) dan membuat server
                    HTTP.
                </div>
            </div>
        </li>
    ...
    <p class="fw-semibold text-primary">
        2.3.1 Menggunakan Modul OS
    </p>
    <p class="lh-lg">
        Berikut script sederhana menggunakan modul OS untuk menampilkan informasi tentang sistem operasi yang sedang
        digunakan.
    </p>
    ...
    <textarea class="code-editor" id="code-os">// Memuat modul 'os'
const os = require('os');
...
console.log(`Arsitektur Sistem: ${architecture}`);</textarea>
    ...
    <script>
        function copyToClipboard() {
            var text = document.getElementById("code-os").innerText;
