...
@section('container-base-content')
    ...
    <p class="lh-lg">
        Modul Event memiliki kemampuan untuk menangani event secara efisien, yang menjadikan modul ini sebagai komponen
        utama dalam pengembangan aplikasi Node.js berbasis event-driven, berikut beberapa fungsi dan manfaat utama dari
        modul event:
    </p>
    <ol class="list-group list-group-numbered">
        <li class="text-dark m-0 p-0 border-0 ms-3 mt-2 list-group-item d-flex justify-content-between align-items-start">
            <div class="ms-2 me-auto ">
                ...
                <p class="lh-lg">
                    EventEmitter digunakan untuk menambahkan event tertentu menggunakan metode on. Listener ini akan
                    dipanggil ketika event tersebut di picu. Listener dapat digunakan untuk menjalankan sejumlah tugas atau
                    proses, seperti respon pada intup data, menjalankan logika aplikasi berdasarkan tindakan yang dilakukan,
                    dan lain-lain.
                </p>
                <textarea class="code-editor">const EventEmitter = require('events');
    ...
    console.log(`Data diterima: ${data}`);
        ...
        <li class="text-dark m-0 p-0 border-0 ms-3 mt-2 list-group-item d-flex justify-content-between align-items-start">
            <div class="ms-2 me-auto ">
                ...
                <p class="lh-lg">
                    Metode emit pada EventEmitter berguna untuk memicu atau menjalankan event yang telah didefinisikan
                    sebelumnya. Ketika event tersebut dipicu, semua listener yang telah didaftarkan akan dieksekusi secara
                    berurutan. Sehingga, memungkinkan aplikasi untuk mengatur flow secara dinamis. Contohnya pada saat dalam
                    sistem notifikasi, kita dapat memicu event ‘notification’ ketika ada pesan yang masuk, sehingga user
                    mendapatkan notifikasi real-time.
                </p>
                <textarea class="code-editor">// Memicu event 'data-received'
myEmitter.emit('data-received', 'Pesan baru untuk Anda');</textarea>
            </div>
        </li>
        <li class="text-dark m-0 p-0 border-0 ms-3 mt-2 list-group-item d-flex justify-content-between align-items-start">
            <div class="ms-2 me-auto ">
                ...
                <p class="lh-lg">
                    removeListener digunakan untuk menghapus listener dari sebuah event, sehingga dapat mengelola konsumsi
                    memori serta dapat meningkatkan performa, terutama pada aplikasi yang memiliki banyak listener aktif.
                    Contohnya setelah user logout atau ketika sesi selesai.
                </p>
                <textarea class="code-editor">const listener = (data) => console.log(`Data diterima: ${data}`);

// Menambahkan dan kemudian menghapus listener
myEmitter.on('data-received', listener);
myEmitter.removeListener('data-received', listener);</textarea>
        ...
        <li class="text-dark m-0 p-0 border-0 ms-3 mt-2 list-group-item d-flex justify-content-between align-items-start">
            <div class="ms-2 me-auto ">
                ...
                <p class="lh-lg">
                    Terkadang, kita ingin listener yang hanya merespon satu kali ketika dipicu, seperti event startup atau
                    load. Dengan menggunakan fungsi once, memungkinkan listener dijalankan hanya satu kali ketika event
                    pertama telah dipicu. Setelah itu, listener tersebut akan dihapus secara otomatis.
                </p>
                <textarea class="code-editor">// Menambahkan listener yang hanya berjalan sekali
...
myEmitter.emit('first-load');</textarea>

            </div>
        </li>
    </ol>
    <p class="lh-lg">
        Dengan adanya fungsi-fungsi diatas, memungkinkan pengembangan membuat aplikasi yang responsif dan efisien. Dengan
        pemanfaatan Modul Event ini sangat sesuai untuk pengembangan aplikasi web, sistem monitoring, dan aplikasi real-time
