...
@section('container-base')
    ...
    @php
        ...
        $userId = auth()->id();
        $completedStep = Progress::where('user_id', $userId)->where('completed', true)->max('step_id'); // Step terakhir yang selesai
                ...
                @elseif(auth()->user()->role == 'admin')
                    <div class="border list-group list-group-flush">
                        <a href="/admin/dashboard"
                            class="py-3 d-flex align-items-center justify-content-between bg-primary-light text-primary-dark false list-group-item {{ Route::is('admin.dashboard') ? 'active' : '' }}">
                            <span><i class="bi bi-speedometer"></i> Dashboard</span></a>
                        <a href="/admin/reset-password"
                            class="py-3 d-flex align-items-center justify-content-between bg-primary-light text-primary-dark false list-group-item {{ Route::is('admin.reset.password') ? 'active' : '' }}">
                            <span><i class="bi bi-key"></i> Reset Password</span></a>
                        <a href="/admin/data-kelas"
                            class="py-3 d-flex align-items-center justify-content-between bg-primary-light text-primary-dark false list-group-item {{ Route::is('admin.data.kelas') ? 'active' : '' }}">
                            <span><i class="bi bi-database"></i> Data Kelas</span></a>
                    </div>
                @elseif(auth()->user()->role == 'mahasiswa')
                    <div class="border list-group list-group-flush">
                        ...
                        <a href="/mahasiswa/leaderboard"
                            ...
                            <span><i class="bi bi-trophy"></i> Leaderboard</span></a>
                        <a href="/mahasiswa/data-nilai"
                            ...
                            <span><i class="bi bi-list-task"></i> Nilai Saya</span></a>
                    ...
                    <div class="accordion vh-100 overflow-auto" id="sidebarAccordion">
                        <div class="accordion-item" id="menuHeading1">
                            ...
                            <div id="menuCollapse1"
                                class="accordion-collapse collapse  {{ Route::is('bab1-*') ? 'show' : '' }}"
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="/pengenalan/pemrograman-sisi-klien-dan-sisi-server"
                                        ...
                                        <span>
                                            ...
                                            @else
                                                <i class="bi bi-lock-fill"></i>
                                            @endif
                                            Pemrograman Sisi Klien dan Sisi Server
                                        </span></a>
                                    ...
                                    <a href="/pengenalan/pemrograman-sinkronus-dan-asinkronus"
                                        ...
                                        <span>
                                            ...
                                            @else
                                                <i class="bi bi-lock-fill"></i>
                                            @endif
                                            Pemrograman Sinkronous dan Asinkronous
                                        </span></a>
                                    <a href="/pengenalan/hubungan-nodejs-dengan-browser"
                                        ...
                                        <span>
                                            ...
                                            @else
                                                <i class="bi bi-lock-fill"></i>
                                            @endif Hubungan Node.js dengan Browser
                                        </span></a>
                        ...
                        <div class="accordion-item" id="menuHeading2">
                            ...
                            <div id="menuCollapse2"
                                class="accordion-collapse collapse  {{ Route::is('bab2-*') ? 'show' : '' }}"
                        ...
                        <div class="accordion-item" id="menuHeading3">
                            ...
                            <div id="menuCollapse3"
                                class="accordion-collapse collapse  {{ Route::is('bab3-*') ? 'show' : '' }}"
                        ...
                        <div class="accordion-item" id="menuHeading4">
                            ...
                            <div id="menuCollapse4"
                                class="accordion-collapse collapse  {{ Route::is('bab4-*') ? 'show' : '' }}"
                                    ...
                                    <a href="/modul-event/fungsi-dan-manfaat-modul-event"
                                        ...
                                        <span>
                                            ...
                                            @else
                                                <i class="bi bi-lock-fill"></i>
                                            @endif
                                            Fungsi dan Manfaat Modul Event
                                        </span></a>
                        ...
                        <div class="accordion-item" id="menuHeading5">
                            ...
                            <div id="menuCollapse5"
                                class="accordion-collapse collapse  {{ Route::is('bab5-*') ? 'show' : '' }}"
                                    ...
                                    <a href="/modul-file-system/fungsi-dan-operasi-dasar-modul-file-system"
                                        ...
                                        <span>
                                            ...
                                            @else
                                                <i class="bi bi-lock-fill"></i>
                                            @endif
                                            Fungsi dan Operasi Dasar Modul File System
                                        </span></a>
                                    <a href="/modul-file-system/contoh-kode-modul-file-system"
                                        ...
                                        <span>
                                            ...
                                            @else
                                                <i class="bi bi-lock-fill"></i>
                                            @endif
                                            Contoh Kode Module File System
                                        </span></a>
                        ...
                        <div class="accordion-item" id="menuHeading6">
                            ...
                            <div id="menuCollapse6"
                                class="accordion-collapse collapse  {{ Route::is('bab6-*') ? 'show' : '' }}"
                                    ...
                                    <a href="/modul-http/contoh-kode-penggunaan-modul-http"
                                        ...
                                        <span>
                                            ...
                                            @else
                                                <i class="bi bi-lock-fill"></i>
                                            @endif
                                            Contoh kode Penggunaan Modul HTTP
                                        </span></a>
            ...
            <div class="p-4 p-lg-5">
                ...
                @if (!request()->is('dosen/*') && !request()->is('mahasiswa/*') && !request()->is('admin/*'))
                    <div class="w-100 py-5 d-flex align-items-center justify-content-between bottom-0  ">
                        ...
                        @if ($nextUrl)
                            <a href="{{ $nextUrl }}"
                                class="d-flex align-items-center py-2 px-3 text-white btn btn-success {{ $isCompleted ?? true ? '' : 'disabled' }}"
                                id="nextButton">
